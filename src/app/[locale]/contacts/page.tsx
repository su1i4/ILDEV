...
// плавающие шары: размер, вертикаль, цвет, скорость, старт (минус = уже в пути на загрузке)
const ORBS = [
  {
    size: 320,
    top: "10%",
    color: "rgba(219,119,70,0.45)",
    duration: 26,
    delay: 0,
  },
];
...
const Contacts = () => {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-y-auto pt-[250px] md:pt-[150px]">
      <div className="container mx-auto">
        {/* мягкое тёплое свечение-подложка */}
        <div className="pointer-events-none absolute inset-0 z-0 bg-services-glow bg-[length:150%_150%] animate-glowDrift" />

        {/* плавающие шары: слева направо → растворяются → снова слева */}
        <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
          {ORBS.map((o, i) => (
            <div
              key={i}
              className="absolute rounded-full blur-3xl mix-blend-screen animate-orbFloat"
              style={{
                width: o.size,
                height: o.size,
                top: o.top,
        ...
        <div className="relative z-10 flex lg:flex-col justify-between items-center gap-10 max-w-[90%] md:max-w-[85%] lg:max-w-[80%] mx-auto">
          <div
