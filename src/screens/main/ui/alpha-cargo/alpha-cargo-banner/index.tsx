...
const AlphaCargoBanner = () => {
  ...
  return (
    <div className="flex flex-col justify-between gap-[50px] px-6 sm:px-3  xs:px-2 ">
      <div className="relative flex lg:flex-col pt-20 lg:pt-32 px-4  lg:px-8 mt-[100px] xs:mt-[10px] lg:gap-[88px]    ">
        <motion.div
      ...
      >
        <div>
          ...
          <div className="flex flex-col gap-4 mt-[40px]">
            ...
            <div className="flex gap-[20px]  text-white rounded-lg flex-wrap">
              <div className=" max-w-[671px] w-full md:w-[100px] flex-1 border border-gray-700 p-[30px] xs:p-[15px] ">
                ...
                <p className="text-[48px] md:text-[32px] sm:text-[18px] xs:text-[15px]  font-medium">
              ...
              <div className=" max-w-[671px] w-full md:w-[100px] flex-1 border border-gray-700 p-[30px] xs:p-[15px]">
                ...
                <p className="text-[48px] md:text-[32px] sm:text-[18px] xs:text-[15px]  font-medium leading-[43.2px] md:leading-6">
